...
st.page_link("/workspaces/MyWebsite/personal-portfolio /pages/projects/GameDayNotificationsApp.py", label="🔗 View Project →", icon="🏀")
...
st.page_link("/workspaces/MyWebsite/personal-portfolio /pages/projects/WeatherDashboardDemo.py", label="🔗 View Project →", icon="🌤️")

st.markdown("#### 🔸 Cloud Uploader CLI")
st.write("Bash-based tool to encrypt and upload files to GCP storage buckets.")
st.page_link("/workspaces/MyWebsite/personal-portfolio /pages/projects/CloudUploaderCLI.py", label="🔗 View Project →", icon="☁️")
st.markdown("---")
...
st.page_link("/workspaces/MyWebsite/personal-portfolio /pages/projects/OktaAppIntegration_ServiceNow.py", label="🔗 View Project →", icon="🔐")

st.markdown("#### 🔸 GCP VM – AD Setup")
st.write("Provisioned a Windows Server VM on GCP and installed/configured Active Directory.")
st.page_link("/workspaces/MyWebsite/personal-portfolio /pages/projects/GCPVM_AD.py", label="🔗 View Project →", icon="🖥️")
...
st.page_link("/workspaces/MyWebsite/personal-portfolio /pages/projects/AWSVM_AD_Okta.py", label="🔗 View Project →", icon="🧩")
...
st.page_link("/workspaces/MyWebsite/personal-portfolio /pages/projects/SAML_Okta_Salesforce.py", label="🔗 View Project →", icon="🔐")
st.markdown("---")
...
st.page_link("/workspaces/MyWebsite/personal-portfolio /pages/projects/andNameGeneratorApp.py", label="View Project →")

st.markdown("#### 🔸 Tip Calculator App  ")
st.markdown("Streamlit-based app that calculates tip amount and splits bill among people.  ")
st.page_link("/workspaces/MyWebsite/personal-portfolio /pages/projects/TipCalculatorApp.py", label="View Project →")

st.markdown("#### 🔸 Warrior Wizard Dragon Game  ")
st.markdown("Interactive Streamlit game like Rock, Paper, Scissors.  ")
st.page_link("/workspaces/MyWebsite/personal-portfolio /pages/projects/WarriorWizardDragonApp.py", label="View Project →")

st.markdown("#### 🔸 Treasure Island Game  ")
st.markdown("Streamlit adventure game built as a beginner project.  ")
st.page_link("/workspaces/MyWebsite/personal-portfolio /pages/projects/TreasureIslandApp.py", label="View Project →")
st.markdown("---")
