...
st.page_link("pages/GameDayScheduleAPI.py", label="🔗 View Project →", icon="📅")
...
st.page_link("pages/GameDayNotificationsApp.py", label="🔗 View Project →", icon="🏀")
...
st.page_link("pages/CloudUploaderCLI.py", label="🔗 View Project →", icon="☁️")
st.markdown("---")
...
st.page_link("pages/AWSVM_AD_Okta.py", label="🔗 View Project →", icon="🧩")
...
st.page_link("pages/SAML_Okta_Salesforce.py", label="🔗 View Project →", icon="🔐")
st.markdown("---")
...
st.page_link("pages/TipCalculatorApp.py", label="🔗 View Project →", icon="🧮")

st.markdown("#### 🔸 Warrior Wizard Dragon Game  ")
st.markdown("Interactive Streamlit game like Rock, Paper, Scissors.  ")
st.page_link("pages/WarriorWizardDragonApp.py", label="🔗 View Project →", icon="⚔️")

st.markdown("#### 🔸 Treasure Island Game  ")
st.markdown("Streamlit adventure game built as a beginner project.  ")
st.page_link("pages/TreasureIslandApp.py", label="🔗 View Project →", icon="🗺️")
st.markdown("---")
